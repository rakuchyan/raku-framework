...
trait RestfulResponse
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function success($data = [], array $headers = [], $message = 'successful'): JsonResponse
    {
        $this->header = $headers;
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function error(string $message = '', int $code = 400, $data = []): JsonResponse
    {
        if (empty($data)) {
            $data = new stdClass();
        }
     ...
     * @return JsonResponse
     */
    protected function response(string $message, $data = [], int $code = 200, int $status = 200): JsonResponse
    {
        $msgpack = [
            'code' => $code,
            'message' => $message,
